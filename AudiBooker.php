...
$mail = new PHPMailer();
$body = "Auditorium Booking Reg: $hall1 has been requested!!!<br><br>
Respected Sir/Madam,<br><br>
	  ...
	  Requesting Auditorium: $hall1 <br><br>
	  ...
	  Video Conferrencing - $_POST[VideoConf]<br><br>
	  Display Board - $_POST[Board]<br><br>
...
$sql1="insert into auditorium values($random,'$n1','$dept1','$hall1','$pur1','$level1','$da1','$da2','$time1','$time2','$chief_name','$institution','$program','$des1','$_POST[Photo]','$_POST[Video]','$_POST[VideoConf]','$_POST[Board]',$priority,'$timestamp','none')";
$result1 = mysqli_query($con,$sql1);
if($result1)
{
	header('Location:'.'Dashboard.php');
/*$body1 = "Hall Request Reg: <br>Hello $n1, your request has been sent to the Admin.<br><br>
  So you wait for Auditorium Confirmation mail from the Admin.<br><br>
  Requested Auditorium: $hall1<br>
