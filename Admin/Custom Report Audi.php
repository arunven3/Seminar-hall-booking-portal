...
if($month==01)
{
	$sql = $sql." from auditorium where sdate>='".$year."-".$month."-01' and edate<='".$year."-".$month."-31'";
}
if($month==02)
{
	if($year%4==0)
	{
		$sql = $sql." from auditorium where sdate>='".$year."-".$month."-01' and edate<='".$year."-".$month."-29'";
	}
	$sql = $sql." from auditorium where sdate>='".$year."-".$month."-01' and edate<='".$year."-".$month."-28'";
}
if($month==03)
{
	$sql = $sql." from auditorium where sdate>='".$year."-".$month."-01' and edate<='".$year."-".$month."-31'";
...
if($month==04)
{
	$sql = $sql." from auditorium where sdate>='".$year."-".$month."-01' and edate<='".$year."-".$month."-30'";
}
if($month==05)
{
	$sql = $sql." from auditorium where sdate>='".$year."-".$month."-01' and edate<='".$year."-".$month."-31'";
...
$DB_TBLName = "auditorium"; //MySQL Table Name   
