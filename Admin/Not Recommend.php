...
$etime = $_POST['etime'];
//echo "$sdate";
$all = array("Mechanical Seminar Hall","Civil Seminar Hall","EEE Seminar Hall","ECE Seminar Hall","CSE Seminar Hall","IT Seminar Hall");
/*foreach ($all as $key) 
{
    echo "$key";   # code...
}*/
$con=mysqli_connect("localhost","root","","tce");
        ...
        $sql = "select l.Hall from log l where  l.sdate='$sdate' and l.edate='$edate' and l.stime='$stime' and l.etime='$etime' and l.HOD='Recommended' and l.Admin='Approved'";
