...
$mail = new PHPMailer();
$body = "QEEE Hall Booking Reg: $hall1 has been requested!!!<br><br>
...
$sql1="insert into qeee values($random,'$n1','$dept1','$hall1','$pur1','$level1','$da1','$da2','$time1','$time2','$chief_name','$institution','$program','$des1','$_POST[Photo]','$_POST[Video]','$_POST[VideoConf]','$_POST[Board]',$priority,'$timestamp','none')";
