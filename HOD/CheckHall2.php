...
<title>Tentative Availability</title>
<script>
    var til;
    function ardir() {
        var ar;
...
<body>
<header>
    <h2><?php echo "$dept";?> Seminar Hall Tentative Timings</h2>
</header>
        ...
        <div style="padding-top: 0px">
            <div class="f2a">
                <div class="wr2">
                        ...
                        $sql = "select * from log where HOD='Recommended' and Admin='Approved' and Hall='$dept Seminar Hall' and sdate='$newDateString'";
                        $sql1 = "select * from log where HOD='Recommended' and Admin='Approved' and Hall='$dept Seminar Hall' and edate='$newDateString'";
                        $sql2 = "select * from log where HOD='none' and Admin='none' and Hall='$dept Seminar Hall' and sdate='$newDateString'";
                        $sql3 = "select * from log where HOD='none' and Admin='none' and Hall='$dept Seminar Hall' and edate='$newDateString'";
                        $sql4 = "select * from log where HOD='Recommended' and Admin='Approved' and Hall='$dept Seminar Hall' and '$newDateString' between sdate and edate";
                        $sql5 = "select * from log where HOD='none' and Admin='none' and Hall='$dept Seminar Hall' and '$newDateString' between sdate and edate";
                        $sql6 = "select * from log where HOD='Recommended' and Admin='none' and Hall='$dept Seminar Hall' and sdate='$newDateString'";
                        $sql7 = "select * from log where HOD='Recommended' and Admin='none' and Hall='$dept Seminar Hall' and edate='$newDateString'";
                        $sql8 = "select * from log where HOD='Recommended' and Admin='none' and Hall='$dept Seminar Hall' and '$newDateString' between sdate and edate";
