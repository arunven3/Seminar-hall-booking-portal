...
<?php
    $Id1=$_POST["id"];
        ...
        $sql="select * from log where id=$Id1 and Hall='$_SESSION[us3] Seminar Hall'";
        ...
        <input type='submit' name='Recommend' value='Forward'>
    </form></td>
    <td><form action='Not Recommend.php' method='post'>
        <input type='hidden' name='id' value='$id1'>
        <input type='hidden' name='sdate' value='$sdate'>
        <input type='hidden' name='edate' value='$edate'>
        <input type='hidden' name='stime' value='$stime'>
