...
function goHome()
{
  window.location='DashboardHod.php';
    ...
    <title>Seminar Halls Booking Site</title>
     <style>
     *{
        margin: 0px;
        padding: 0px;
...
{
 $seminar = "Civil Seminar Hall";
}
if(isset($_POST["Mechanical"]))
{
 $seminar = "Mechanical Seminar Hall";
}
if(isset($_POST["EEE"]))
{
 $seminar = "EEE Seminar Hall";
}
if(isset($_POST["ECE"]))
{
 $seminar = "ECE Seminar Hall";
}
if(isset($_POST["CSE"]))
{
 $seminar = "CSE Seminar Hall";
}
if(isset($_POST["IT"]))
{
 $seminar = "IT Seminar Hall";
}
 ?>
    <body onload="emptyField()">
        <header>
        <h2><?php echo "$seminar";?></h2>
    </header>
...
<form method="post" action="HallBooker.php">
  ...
  <?php
                    if(isset($seminar)) // If session is not set then redirect to Login Page
                    {
                        echo "<input type=\"hidden\" name=\"Hall\" value='$seminar'>";
                    }
                    ?>
 <span style="padding-right: 630px;"></span><input type="submit" name="book" value="Book"/>
</form>
  <div>
            <footer>
