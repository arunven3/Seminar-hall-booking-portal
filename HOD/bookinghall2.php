...
function goHome()
{
  window.location='DashboardHod.php';
    ...
    <title>Auditorium Booking Site</title>
     <style>
     *{
        margin: 0px;
        padding: 0px;
...
<?php
if(isset($_POST["ksaudi"]))
{
 $seminar = "KS Auditorium";
}
if(isset($_POST["kmaudi"]))
{
 $seminar = "KM Auditorium";
}
if(isset($_POST["openaudi"]))
{
 $seminar = "Open Auditorium";
}
 ?>
...
<form method="post" action="AudiBooker.php">
