  ...
  const DOMstrings = {
    ...
    function createCal(year, month) {
        ...
        for (i = 0; i < calendar.length; i++) {
            for (j = 0; j < 6; j++)
            {
                if (typeof calendar[i][j] === 'undefined') {
                    calendar[i][j]="";
                    }
            }
            calendar[i] = '<tr><td class="eformDay  a'+calYear+'-'+calMonth+'-'+calendar[i][0]+'" onclick="calender.dayClick(this)">'+calendar[i][0]+'<td class="eformDay a'+calYear+'-'+calMonth+'-'+calendar[i][1]+'" id="'+calendar[i][1]+'"  onclick="calender.dayClick(this)">'+calendar[i][1]+'</td><td class="eformDay  a'+calYear+'-'+calMonth+'-'+calendar[i][2]+'" id="'+calendar[i][2]+'"  onclick="calender.dayClick(this)">'+calendar[i][2]+'</td><td class="eformDay a'+calYear+'-'+calMonth+'-'+calendar[i][3]+'" id="'+calendar[i][3]+'"  onclick="calender.dayClick(this)">'+calendar[i][3]+'</td><td class="eformDay  a'+calYear+'-'+calMonth+'-'+calendar[i][4]+'" id="'+calendar[i][4]+'" onclick="calender.dayClick(this)">'+calendar[i][4]+'</td><td class="eformDay  a'+calYear+'-'+calMonth+'-'+calendar[i][5]+'" id="'+calendar[i][5]+'" onclick="calender.dayClick(this)">'+calendar[i][5]+'</td><td class="eformDay a'+calYear+'-'+calMonth+'-'+calendar[i][6]+'" id="'+calendar[i][6]+'" onclick="calender.dayClick(this)">'+calendar[i][6]+'</td></tr>';
        }
